[luftdaten_to_charlcd.py](luftdaten_to_charlcd.py) is a script that lets your weather data which you collect with your NodeMCU display on an Adafruit 16x2 CharLCD.
